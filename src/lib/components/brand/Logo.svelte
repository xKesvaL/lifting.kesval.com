<script lang="ts">
	...
	export let origin: 'center' | 'left' = 'center';
...
>
	...
	>
		<text
			...
			class="fill-base-content transition-all duration-300"
			><tspan x="275" y="292" id="tspan1319"
				><tspan style="font-size:107px;font-family:'Benzin Semibold',serif;" id="tspan1317">
					{common.appName}
				</tspan></tspan
			></text
		>
